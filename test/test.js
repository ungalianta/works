...
window.addEventListener("resize", () => {
    if (window.innerWidth > 768) {
        searchInput.style.display = 'flex'; // Показываем  инпут на больших экранах
    } else {
        searchInput.style.display = 'none'; // Скрываем инпут на меньших экранах
    }
});
...
function displayResults(results) {
    ...
    results.forEach(product => {
        ...
        productDiv.className = "product-page";
